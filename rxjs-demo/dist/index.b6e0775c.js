...
})({"lgGzR":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "413d2e70b6e0775c";
"use strict";
...
},{}],"g0lgE":[function(require,module,exports) {
...
function customOp(val) {
    return function(source$) {
        ...
        source$.subscribe((data)=>{
            if (data <= val) return _rxjs.of(data);
        });
        return _rxjs.from([
            1,
            2,
...
_rxjs.interval(1000).pipe(customOp(5), _rxjs.take(4)).subscribe(console.log) // const sub = new AsyncSubject();
...
},{"tslib":"j55WF","../observable/zip":"97KMy","../util/lift":"acAIF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["lgGzR","g0lgE"], "g0lgE", "parcelRequire5b2b")

//# sourceMappingURL=index.b6e0775c.js.map
